<template>
    <div>
        ...
        <div class="index-list">
          <el-carousel height="400px" class="index-list__car">
            <el-carousel-item v-for="item in imgs" :key="item" class="lunbo">
              <img :src="item">
            </el-carousel-item>
          </el-carousel>
          <div class="a">
...
export default {
  data () {
    return {
      ...
      schedule: {msg: '暂无待办', time: '2022-08-08 10:17'},
      message: {name: '自己', msg: '没有后台，死页面', grade: 5, time: '2022-07-07 10:17'},
      time: new Date()
    }
  },
  components: {
